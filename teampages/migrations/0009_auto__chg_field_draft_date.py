...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Draft.date'
        db.alter_column(u'teampages_draft', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Draft.date'
        db.alter_column(u'teampages_draft', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0)))
    ...
    models = {
        ...
        u'teampages.draftpick': {
            ...
            'draft': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['teampages.Draft']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pick_number': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
