...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DraftPick.pick_number'
        db.add_column(u'teampages_draftpick', 'pick_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DraftPick.pick_number'
        db.delete_column(u'teampages_draftpick', 'pick_number')
