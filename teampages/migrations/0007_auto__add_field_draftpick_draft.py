...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DraftPick.draft'
        db.add_column(u'teampages_draftpick', 'draft',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teampages.Draft'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DraftPick.draft'
        db.delete_column(u'teampages_draftpick', 'draft_id')
