...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stat.games_played'
        db.add_column(u'teampages_stat', 'games_played',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stat.games_played'
        db.delete_column(u'teampages_stat', 'games_played')
