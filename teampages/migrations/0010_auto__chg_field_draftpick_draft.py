...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DraftPick.draft'
        db.alter_column(u'teampages_draftpick', 'draft_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teampages.Draft']))

    def backwards(self, orm):

        # Changing field 'DraftPick.draft'
        db.alter_column(u'teampages_draftpick', 'draft_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teampages.Draft'], null=True))
    ...
    models = {
        ...
        u'teampages.fapickup': {
            ...
            'player_added': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player_added'", 'blank': 'True', 'to': u"orm['teampages.Player']"}),
            'player_dropped': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player_dropped'", 'blank': 'True', 'to': u"orm['teampages.Player']"}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['teampages.Team']"})
        },
        u'teampages.player': {
